...
no_of_lines=len(listfin)
print(no_of_lines,"  THIS IS NO OF LINES")
for loki in listfin:
   print(loki[0]["desc"])
   no_of_words=len(loki[0]["desc"])
   print(no_of_words," THIS IS NO OF WORDS ")
   for loku in loki[0]["desc"]:
       print("WORD ::::",loku)
   for loku in loki[0]["vertices"]:    
       print("x1,y1,x2,y2 ::::: ",loku)
